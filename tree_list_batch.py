...
#         print('-------------------'*10)
  ...
  #         Tree(content[i],tree[i])
  #         final_trees.append(
  #         print('Leaves = ',Tree.get_words)
...
#   print('Final trees =', final_trees)
        ...
        for i in range(1): #This only works for single jet studies. Modify for full events
          ...
          jet["content"] = np.reshape(content[i],(-1,4,1)) #Where content[i][0] is the jet 4-momentum, and the other entries are the jets constituents 4 momentum? (SM)
          jet["mass"] = mass[i]
          jet["pt"] = pt[i]
...
if __name__=='__main__':
  ...
  bkg_tree, bkg_list=makeTrees(dir_jets_subjets,bg,myN_jets,0)
